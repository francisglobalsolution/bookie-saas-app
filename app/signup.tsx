...
async function signUp({ name, email, password }: SignUpParams): Promise<User> {
  try {
    const response = await fetch(
      "https://6850d0408612b47a2c079e71.mockapi.io/api/v1/users",
      {
        method: "POST",
        headers: {
...
export default function SignUpScreen() {
  ...
  return (
    <View
      style={[viewStyles.container, isMobile && viewStyles.containerMobile]}
    >
      {isMobile ? (
        <>
          ...
          <View style={viewStyles.formCardMobile}>
            ...
            <Text style={textStyles.subtitleMobile}>
            ...
            <View style={viewStyles.inputGroup}>
              ...
              <View style={viewStyles.passwordRow}>
                ...
                <TouchableOpacity
                  ...
                  style={viewStyles.eyeButton}
                >
                  <Text style={textStyles.eyeIcon}>
                    {showPassword ? "🙈" : "👁️"}
                  </Text>
                </TouchableOpacity>
              </View>
            ...
            <View style={viewStyles.socialRow}>
              <TouchableOpacity style={viewStyles.socialButton}>
                <Image
                  ...
                  style={inputStyles.socialIcon}
                />
                <Text style={textStyles.socialText}>Sign up with Google</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[viewStyles.socialButton, viewStyles.facebookButton]}
              >
                <Image
                  source={{
            ...
            <View style={viewStyles.signupRow}>
              <Text style={textStyles.signupText}>
        ...
        <>
          <View style={viewStyles.leftPanel}>
            ...
            <Text style={textStyles.sloganSmall}>
              Bookie for all your Booking needs
            </Text>
            <Text style={textStyles.sloganLarge}>
